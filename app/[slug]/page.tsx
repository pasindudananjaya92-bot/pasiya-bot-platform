...
const PAGES: Record<string, { title: string; desc: string }> = {
  ...
  automation: {
    ...
    desc: "Use AI Agent page with your n8n webhook.",
  },
  storage: {
    title: "🗄 Cloud Storage",
...
const HOSTING = [
  {
    name: "GitHub Repo",
    href: "https://github.com/pasindudananjaya92-bot/pasiya-bot-platform",
  },
  ...
  if (!page) {
    return (
      <div>
        ...
        <p className="text-white/60 text-sm">Unknown page: {slug}</p>
      </div>
    );
  }
